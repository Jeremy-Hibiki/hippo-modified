...
class AsyncHippoRAG(BaseHippoRAG, HippoRAGProtocol):
    ...
    async def delete(
        ...
        await self.cleanup_invalid_pike_mappings()
    ...
    async def cleanup_invalid_pike_mappings(self):
    ...
    async def add_pike_mappings(self, query_mappings: dict[str, list[str]] | None = None) -> None:
