...
# Convert the paragraph with its named entity list into a JSON dict of triples.

ner_conditioned_re_frame = """Convert the paragraph with its named entity json into a JSON dict of triples
Paragraph:
```
{passage}
```
