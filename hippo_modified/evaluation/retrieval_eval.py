...
class RetrievalRecall(BaseMetric):
    ...
    def __init__(self, global_config: BaseConfig | None = None):
        super().__init__(global_config)

    def calculate_metric_scores(  # type: ignore
        self, gold_docs: list[list[str]], retrieved_docs: list[list[str]], k_list: list[int] = [1, 5, 10, 20]
        ...
        for example_gold_docs, example_retrieved_docs in zip(gold_docs, retrieved_docs, strict=False):
