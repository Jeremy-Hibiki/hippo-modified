...
class QAExactMatch(BaseMetric):
    ...
    def calculate_metric_scores(  # type: ignore
        self, gold_answers: list[list[str]], predicted_answers: list[str], aggregation_fn: Callable = np.max
        ...
        for gold_list, predicted in zip(gold_answers, predicted_answers, strict=False):
